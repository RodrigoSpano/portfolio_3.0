...
const NameContainer: React.FC = () => {
  ...
  return (
    <div className='flex flex-col items-center'>
      <h1 className='font-kanit font-extrabold text-[2rem] middle:text-[4.5rem] bg-clip-text text-transparent bg-gradient-to-b dark:from-[#0096c7] dark:to-[#48cae4] from-[#ffd24e] to-[#c0721f]'>
        {
          language === 'es' ? (
