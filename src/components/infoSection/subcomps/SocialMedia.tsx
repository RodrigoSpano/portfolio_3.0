...
const SocialMedia: React.FC = () => {
  ...
  return (
    <div className='flex text-2xl text-[#1f1c19] dark:text-[#A3A3A3] opacity-75 items-center w-[100px]'>
      ...
      <Tooltip content={language === 'en' ? 'Download Resume':'Descargar curriculum'} className='dark:bg-[#A3A3A3] opacity-75 text-[#1f1c19] '>
        <Button size='sm' className='text-[#1f1c19] dark:text-[#A3A3A3] text-2xl bg-transparent border-none outline-none '>
