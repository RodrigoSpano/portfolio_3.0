...
const AboutHeader = () => {
  return (
    <div className='gap-3 flex flex-col'>
      ...
      <p className='max-w-sm text-[#6c6761] dark:text-[#ADA79f] opacity-90'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quaerat nesciunt dolore, culpa enim quasi iure omnis tempora.</p>
    </div>
  )
}
