...
export const experienceDb: dbExperience[] = [
  {
    ...
    description: "Development of an on-demand video application for customer training on the company's services. We work with cloud services (AWS) using the serverless framework, Node.js, React.js, and TypeScript.",
    descripcion: 'Desarrollo de aplicacion de videos on demand para capacitacion de clientes a los servicios de la empresa. Trabajamos con servicios cloud (AWS) con el framework serverless, NodeJs, ReactJs y Typescript.',
